package vn.hust.edu.menufloatbuttonlib;
...
public class FloatingActionButton extends ImageButton {
	...
	public static final int SIZE_NORMAL_0 = 0;
	public static final int SIZE_NORMAL_1 = 1;
	public static final int SIZE_NORMAL_2 = 2;
	public static final int SIZE_NORMAL_3 = 3;
	public static final int SIZE_NORMAL_4 = 4;
	public static final int SIZE_NORMAL_5 = 5;
	...
	private void updateCircleSize() {
		mCircleSize = getDimension(getSizeDiemen());
	}

	public void setSize(@FAB_SIZE int size) {
		if (size != SIZE_NORMAL_0 && size != SIZE_NORMAL_1
				&& size != SIZE_NORMAL_2 && size != SIZE_NORMAL_3
				&& size != SIZE_NORMAL_4 && size != SIZE_NORMAL_5) {
	...
	void updateBackground() {
		...
		LayerDrawable layerDrawable = new LayerDrawable(new Drawable[] {
				getResources().getDrawable(getSizeDrawable()),
				createFillDrawable(strokeWidth),
				createOuterStrokeDrawable(strokeWidth), getIconDrawable() });

		int iconOffset = (int) (mCircleSize - getDimension(getSizeDiemenIcon())) / 2;
	...
	private int getSizeDiemenIcon() {
		switch (mSize) {
		case SIZE_NORMAL_0:
			return R.dimen.fab_icon_size0;
		case SIZE_NORMAL_1:
			return R.dimen.fab_icon_size1;
		case SIZE_NORMAL_2:
			return R.dimen.fab_icon_size2;
		case SIZE_NORMAL_3:
			return R.dimen.fab_icon_size3;
		case SIZE_NORMAL_4:
			return R.dimen.fab_icon_size4;
		case SIZE_NORMAL_5:
			return R.dimen.fab_icon_size0;
	...
	private int getSizeDiemen() {
		switch (mSize) {
		case SIZE_NORMAL_0:
			return R.dimen.fab_size_normal0;
		case SIZE_NORMAL_1:
			return R.dimen.fab_size_normal1;
		case SIZE_NORMAL_2:
			return R.dimen.fab_size_normal2;
		case SIZE_NORMAL_3:
			return R.dimen.fab_size_normal3;
		case SIZE_NORMAL_4:
			return R.dimen.fab_size_normal4;
		case SIZE_NORMAL_5:
			return R.dimen.fab_size_normal5;
